...
const tutorials = {
    html: {
        ...
        content: `
            ...
            <p>HTML is the standard markup language for creating web pages. It provides the structure and content of websites.</p>
...
&lt;/form&gt;</code></pre>
            ...
            <div class="note">
                <strong>Tip:</strong> Always use semantic HTML tags like &lt;header&gt;, &lt;nav&gt;, &lt;main&gt;, &lt;article&gt;, &lt;section&gt;, and &lt;footer&gt; for better accessibility and SEO.
            </div>
        `
    },
    ...
    css: {
        ...
        content: `
            ...
            <p>CSS is used to style and layout web pages, making them visually appealing and responsive.</p>
...
print(person.greet())</code></pre>
    ...
    java: {
        ...
        content: `
            <h2>Java</h2>
            <p>Java is a class-based, object-oriented programming language designed for platform independence.</p>
...
person.greet();</code></pre>
    ...
    cpp: {
        ...
        content: `
            <h2>C++</h2>
            <p>C++ is a powerful, high-performance language with object-oriented and low-level features.</p>
...
int main() {
    ...
    csharp: {
        ...
        content: `
            <h2>C# (C Sharp)</h2>
            <p>C# is a modern, object-oriented language developed by Microsoft for the .NET framework.</p>
